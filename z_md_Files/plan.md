...
## ====== A. priority principle (===prpr) [prpr은 프로젝트의 모든 곳에서 모든 명령을 수행하고 기능을 구현할때 반드시 철저하게 지켜야한다. 나의 질문에 답할때도 무조건 아래의 원칙에 기반하여 답변해라. 1차 MVP 기준으로 답변하지말고, 완성본 기준으로 답변해라.]=========================================================================================================================
...
10. 명령 수행시, 각 항목마다 ctxt.md에 원인, 해결방법, 의도, tradeoff를 `자세하게` 기록할 것. tradeoff가 없을 경우 미작성.
11. ctxt.md파일에 기록시 아래와 같이 기록할 것. AI이름은 클로드는 "CLAUDE" , 코덱스는 "CODEX" 로 작성.

## ===================================================================================================
## ======[지시사항]========< [ 수행한 AI이름 ] 현재날짜 / 현재시간 >=============================================
내가 넣은 프롬프트 그대로 기록~~~
...
...
## ======[아웃풋 로그]======< [ 수행한 AI이름 ] 현재날짜 / 현재시간 >=============================================
수행한 항목마다의 원인 해결방법 의도 tradeoff(없을시 작성하지않음.) 등을 작성~~~
...
...
## ======[[ 수행한 AI이름 ] 끝]======<  현재날짜 / 현재시간 >=============================================


12. context-notes.md , ctxt.md를 참고하며 진행할 것.

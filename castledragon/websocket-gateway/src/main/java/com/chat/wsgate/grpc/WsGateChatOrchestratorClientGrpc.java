...
@Component
@Log4j2
public class WsGateChatOrchestratorClientGrpc implements WsGateChatOrchestratorClient {
	...
	public ChatMessageViewResponseDTO createChatMessage(CreateChatMessageCommand command) {
		...
		ChatMessageViewResponseDTO createdMsgResponse = GrpcToDtoConverter
				.convertGrpcToChatMsgViewDto(chatOrcStub.createChatMessage(commandRequest));
